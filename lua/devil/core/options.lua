...
local options = {
  ...
  cmdheight = 0, -- use command-line popup mode
  ...
  showmode = false, -- we do not need to see -- INSERT -- anymore
  ...
  writebackup = false, -- disable write backup for files edited by other programs
  ...
  guifont = "Fira Code,Noto Color Emoji,FiraCode Nerd Font,Hack Nerd Font:h12",
...
if not vim.uv.os_uname().release:match("gentoo") then
  -- On non-Gentoo systems, remove Vim's runtime path to avoid mixing Vim plugins with Neovim.
