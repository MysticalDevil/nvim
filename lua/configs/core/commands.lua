...
vim.api.nvim_create_user_command("NReplStart", nrepl_start, { desc = "Start nREPL server in clojure project" })
vim.api.nvim_create_user_command("NReplRestart", nrepl_restart, { desc = "Start nREPL server in clojure project" })
vim.api.nvim_create_user_command("NReplStop", nrepl_stop, { desc = "Start nREPL server in clojure project" })
